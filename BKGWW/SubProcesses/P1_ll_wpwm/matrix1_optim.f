...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,11),I=1,4) / 1,-1, 0, 1/
      DATA (NHEL(I,12),I=1,4) / 1,-1, 0, 0/
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL VXXXXX(P(0,3),MDL_MW,+1,+1*IC(3),W(1,5)) ! count 11
      CALL VXXXXX(P(0,3),MDL_MW, 0,+1*IC(3),W(1,6)) ! count 13
      CALL VXXXXX(P(0,3),MDL_MW,-1,+1*IC(3),W(1,7)) ! count 11
      CALL VXXXXX(P(0,4),MDL_MW,+1,+1*IC(4),W(1,8)) ! count 13
      CALL VXXXXX(P(0,4),MDL_MW, 0,+1*IC(4),W(1,9)) ! count 15
      CALL VXXXXX(P(0,4),MDL_MW,-1,+1*IC(4),W(1,10)) ! count 13
      CALL FFV1P0_3(W(1,3),W(1,2),GC_3,ZERO, FK_ZERO,W(1,11)) ! count 7
      CALL FFV1P0_3(W(1,4),W(1,1),GC_3,ZERO, FK_ZERO,W(1,12)) ! count 9
      CALL VVV1P1N_2(W(1,11), W(1,5), -GC_3, TMP(1))
      call CombineAmp(2,
     & (/6,7/), 
     & (/8,9/),
     & TMP, W, AMP(1,1))
      CALL VVV1P1N_2(W(1,11), W(1,6), -GC_3, TMP(1))
      call CombineAmp(3,
     & (/3,4,5/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1))
      CALL VVV1P1N_2(W(1,11), W(1,7), -GC_3, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL VVV1P1N_2(W(1,12), W(1,5), -GC_3, TMP(1))
      call CombineAmp(3,
     & (/14,15,16/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1))
      CALL VVV1P1N_2(W(1,12), W(1,6), -GC_3, TMP(1))
      call CombineAmp(3,
     & (/11,12,13/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1))
      CALL VVV1P1N_2(W(1,12), W(1,7), -GC_3, TMP(1))
      call CombineAmp(3,
     & (/8,9,10/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV2_4_3(W(1,3),W(1,2),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,13)) ! count 7
      CALL FFV2_4_3(W(1,4),W(1,1),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,14)) ! count 9
      CALL VVV1P1N_1(W(1,5), W(1,13), GC_53, TMP(1))
      call CombineAmp(2,
     & (/6,7/), 
     & (/8,9/),
     & TMP, W, AMP(1,2))
      CALL VVV1P1N_1(W(1,5), W(1,14), GC_53, TMP(1))
      call CombineAmp(3,
     & (/14,15,16/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2))
      CALL VVV1P1N_1(W(1,6), W(1,13), GC_53, TMP(1))
      call CombineAmp(3,
     & (/3,4,5/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2))
      CALL VVV1P1N_1(W(1,6), W(1,14), GC_53, TMP(1))
      call CombineAmp(3,
     & (/11,12,13/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2))
      CALL VVV1P1N_1(W(1,7), W(1,13), GC_53, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/9,10/),
     & TMP, W, AMP(1,2))
      CALL VVV1P1N_1(W(1,7), W(1,14), GC_53, TMP(1))
      call CombineAmp(3,
     & (/8,9,10/), 
     & (/8,9,10/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO, FK_ZERO,W(1,15)) ! count 3
      CALL FFV2_1(W(1,1),W(1,6),GC_100,ZERO, FK_ZERO,W(1,16)) ! count 3
      CALL FFV2_1(W(1,1),W(1,7),GC_100,ZERO, FK_ZERO,W(1,17)) ! count 3
      CALL FFV2P1N_2(W(1,4), W(1,8), GC_100, TMP(1))
      call CombineAmp(3,
     & (/14,11,8/), 
     & (/15,16,17/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_2(W(1,4), W(1,9), GC_100, TMP(1))
      call CombineAmp(3,
     & (/15,12,9/), 
     & (/15,16,17/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_2(W(1,4), W(1,10), GC_100, TMP(1))
      call CombineAmp(3,
     & (/16,13,10/), 
     & (/15,16,17/),

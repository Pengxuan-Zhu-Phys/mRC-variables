...
C     
C     Process: e+ e- > z z WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_4_1(W(1,1),W(1,3),GC_50,GC_59,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_4_0(W(1,2),W(1,5),W(1,4),GC_50,GC_59,AMP(1))
      CALL FFV2_4_1(W(1,1),W(1,4),GC_50,GC_59,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_4_0(W(1,2),W(1,5),W(1,3),GC_50,GC_59,AMP(2))

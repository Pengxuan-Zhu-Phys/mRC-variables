...
def plot(wmass):
    ...
    data = pd.read_csv(os.path.abspath(f"{pwd}/../../Events/WMass/{wmass}.csv"))
    xsect = 194.167
    ...
    # data = pd.read_csv(f"{pwd}/Data/TEST.csv")
    ...
    cc = ax.hist2d(data['mRCmin'], data['mRCmax'], 120, range=[[0, 120], [0, 120]], cmap=cmap, cmin=weight, norm=matplotlib.colors.LogNorm(vmin=weight), zorder=10)
    axx.hist(data['mRCmin'], 120, color='#2e66ff', histtype="stepfilled", alpha=0.5, orientation='vertical', zorder=10)
    axx.hist(data['mRCmin'], 120, color='#231aa5', histtype="step", alpha=1, orientation='vertical', zorder=10)
    axy.hist(data['mRCmax'], 120, color='#2e66ff', histtype="stepfilled", alpha=0.5, orientation='horizontal', zorder=10)
    axy.hist(data['mRCmax'], 120, color='#231aa5', histtype="step", alpha=1, orientation='horizontal', zorder=10)
    ...
    # plt.show()
    plt.savefig("Figure/{}.png".format(wmass))
...
if __name__ == "__main__":
    for wmass in ['80330', '80340', '80350', '80360', '80370', '80380', '80385', '80388', '80390', '80392', '80395', '80400', '80410', '80420', '80430', '80440', '80450']:
        plot(wmass)